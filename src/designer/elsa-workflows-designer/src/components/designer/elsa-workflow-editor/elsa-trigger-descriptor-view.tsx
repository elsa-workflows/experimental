...
export const TriggerDescriptorView: FunctionalComponent<TriggerDescriptorProps> = ({triggerDescriptor}) => (
  <div class="border border-solid border-green-600 rounded-md bg-green-400 text-white overflow-hidden" draggable={true}>
    <div class="flex flex-row">
      <div class="flex flex-shrink items-center bg-green-500">
        <div class="px-2 py-1">
